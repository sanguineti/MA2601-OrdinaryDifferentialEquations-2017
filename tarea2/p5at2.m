%Bloqueo Eléctrico (Pregunta 5)
%Parámetros para el calculo de u(t) y r(t)
%Es el mismo código usado (y explicado) en la p1
c1 = 0.175;
c2 = 0.025;
alfa = 0.1;
c3 = 0.65;
t = (0:1:800);
u0 = 1.5 * alfa; %Este es el parametro modificado para simular la patologíaa
u = zeros(1, length(t));
u(1) = u0;
r = zeros(1, length(t));
r(1) = 0;
...
%Es el mismo código usado (y explicado) en la p2
t = (0:1:800);
b1 = -0.03;
b2 = 20;
X = 0.3;
...
subplot(2, 2, 4), plot(t, u); title('Potencial eléctrico normalizado u(t)'); x
hold off
