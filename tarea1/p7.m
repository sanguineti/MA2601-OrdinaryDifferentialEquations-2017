...
%f a variar
f = 0.0005;
%Vectores a usar para u(t) con ambos metodos
uModif = zeros(1, length(t));
uProgre = zeros(1, length(t));
utilda = zeros(1, length(t));

for j = 1:n / h
    %C�lculo de u(t) con Euler modificado
    uModif(1) = 0;
    ...
    %C�lculo de u(t) con Euler progresivo
    uProgre(1) = 0;
...
plot(t, uModif, 'r')
title('Gr�fico de u(t) con f=0.0005 (Usando Euler Progresivo y Modificado)')
hold off
